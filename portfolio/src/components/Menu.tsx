...
function Menu() {
    ...
    return (
      <>
        <div className="bg-gray-500 font-mono border-2 border-gray-500 pl-2 text-white">Menu</div>
            <div className="bg-neutral-950/50 font-mono w-fit border-2 border-gray-500 leading-none">
                ...
                <span>
                    <span className='pl-4 pr-4'>About</span>
                </span>
                <span>
                    <span className='pl-4 pr-4'>Projects</span>
                </span>
                <span>
                    <span className='pl-4 pr-4'>Contact</span>
                </span>
                </div>
                <img src={logo} className="object-none pt-5 pr-60 pl-60"></img>
                <br />
                <div className="p-5 text-gray-700">
                    <button className="btn-menu text-green-300 w-full p-1 justify-between flex">
                        <span>[about]</span>
                    ...
                    <button className=" btn-menu text-green-300 w-full p-1 justify-between flex"><span>[contact]</span><span className="child float-right text-gray-400">Email me!</span></button>
                </div>
